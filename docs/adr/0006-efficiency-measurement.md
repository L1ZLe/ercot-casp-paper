...
## Rationale
- SPARC is the efficiency story: 8,978 trainable params vs LSTM 34,952 and MLP 64,456 - about 4x smaller than LSTM and 7x smaller than MLP. This mirrors the anchor paper (Yu et al.) efficiency thesis and is a headlining claim.
