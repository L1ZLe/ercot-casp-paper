...
Post-submission cleanup → converting an ad-hoc repo into the project-hygiene framework. Bootstrapped on 2026-09-03.
...
- Never move `charts/` — `paper.tex` and `paper_final.md` reference `charts/fig_*.png`; moving breaks the paper build.
